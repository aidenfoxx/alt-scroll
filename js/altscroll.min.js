...
AltScroll.prototype.touchStart=function(){this.scrollStop();this.touch=!0};AltScroll.prototype.touchEnd=function(){this.touch&&this.options.snap&&(this.snapDelay(),this.touch=!1)};
