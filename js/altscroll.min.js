...
AltScroll.prototype.bindEvents=function(){"ontouchstart"in window?(this.container.addEventListener("touchstart",this.touchStart.bind(this)),window.addEventListener("touchend",this.touchEnd.bind(this)),window.addEventListener("touchcancel",this.touchEnd.bind(this))):0<navigator.maxTouchPoints?(this.container.addEventListener("pointerdown",this.touchStart.bind(this)),window.addEventListener("pointerout",this.touchEnd.bind(this))):0<navigator.msMaxTouchPoints&&(this.container.addEventListener("MSPointerDown",
this.touchStart.bind(this)),window.addEventListener("MSPointerOut",this.touchEnd.bind(this)));this.container.addEventListener("mousedown",this.dragStart.bind(this));window.addEventListener("mouseup",this.dragEnd.bind(this));window.addEventListener("resize",this.resize.bind(this));this.options.snap?(this.container.addEventListener("mousewheel",this.snapDelay.bind(this)),this.container.addEventListener("DOMMouseScroll",this.snapDelay.bind(this))):(this.container.addEventListener("mousewheel",this.scrollStop.bind(this)),
this.container.addEventListener("DOMMouseScroll",this.scrollStop.bind(this)))};AltScroll.prototype.resize=function(){clearTimeout(this.resizeTimeout);this.resizeTimeout=setTimeout(function(){this.resizeCallback()}.bind(this),500)};AltScroll.prototype.resizeCallback=function(){this.hideScrollbars();this.containerRect=this.container.getBoundingClientRect();this.contentRect=this.content.getBoundingClientRect();this.childRect=this.getChildRect()};
