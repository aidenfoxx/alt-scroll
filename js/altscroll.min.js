...
AltScroll.prototype.bindEvents=function(){this.container.addEventListener("touchstart",this.scrollStop.bind(this));this.container.addEventListener("mousedown",this.dragStart.bind(this));window.addEventListener("resize",this.resize.bind(this));window.addEventListener("mouseup",this.dragEnd.bind(this));this.options.snap&&(this.container.addEventListener("mousewheel",this.snapDelay.bind(this)),this.container.addEventListener("DOMMouseScroll",this.snapDelay.bind(this)),this.container.addEventListener("touchend",
this.snapDelay.bind(this)),this.container.addEventListener("touchcancel",this.snapDelay.bind(this)))};AltScroll.prototype.resize=function(){clearTimeout(this.resizeTimeout);this.resizeTimeout=setTimeout(function(){this.resizeCallback()}.bind(this),500)};AltScroll.prototype.resizeCallback=function(){this.hideScrollbars();this.containerRect=this.container.getBoundingClientRect();this.contentRect=this.content.getBoundingClientRect();this.childRect=this.getChildRect()};
